"""
Implementation of slimmable SNGAN for image size 64.
"""
import torch
...
class SlimmableSNGANGenerator64(slimmable_sngan_base.SlimmableSNGANBaseGenerator):
    r"""
    ...
    """
    def __init__(self, nz=128, ngf=1024, bottom_width=4, alpha=0, stepwise=False,**kwargs):
        ...
        self.block5 = SlimmableGBlock(self.ngf >> 3, self.ngf >> 4, upsample=True)
        self.b6 = SwitchableBatchNorm2d([int(self.ngf * width_mult) >> 4 for width_mult in FLAGS.width_mult_list])
        self.c6 = SlimmableConv2d([int(self.ngf * width_mult) >> 4 for width_mult in FLAGS.width_mult_list], [3 for _ in FLAGS.width_mult_list], 3, 1, padding=1)
...
class SlimmableSNGANDiscriminator64(slimmable_sngan_base.SlimmableSNGANBaseDiscriminator):
    r"""
    ...
    def __init__(self, ndf=1024, n_share=0, **kwargs):
        ...
        for width_mult in FLAGS.width_mult_list:
            ...
            block5s.append(DBlock(self.ndf >> 1, self.ndf, downsample=True))
