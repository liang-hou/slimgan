"""
Implementation of slimmable SNDCGAN for image size 32.
"""
import torch
...
class SlimmableSNDCGANGenerator32(slimmable_sndcgan_base.SlimmableSNDCGANBaseGenerator):
    r"""
    ...
    """
    def __init__(self, nz=128, ngf=512, bottom_width=4, alpha=0, stepwise=False, **kwargs):
...
class SlimmableSNDCGANDiscriminator32(slimmable_sndcgan_base.SlimmableSNDCGANBaseDiscriminator):
    r"""
