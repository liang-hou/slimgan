"""
Base implementation of slimmable SNDCGAN with default variables.
"""
import torch
...
class SlimmableSNDCGANBaseGenerator(gan.BaseGenerator):
    r"""
    ...
    """
    def __init__(self, nz, ngf, bottom_width, loss_type='hinge', alpha=0, stepwise=False, **kwargs):
...
class SlimmableSNDCGANBaseDiscriminator(gan.BaseDiscriminator):
    r"""
    DCGAN backbone discriminator for slimmable SNDCGAN.
