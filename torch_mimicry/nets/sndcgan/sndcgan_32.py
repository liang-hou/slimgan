"""
Implementation of SNDCGAN for image size 32.
"""
import torch
...
class SNDCGANGenerator32(sndcgan_base.SNDCGANBaseGenerator):
    r"""
    ...
    """
    def __init__(self, nz=128, ngf=512, bottom_width=4, **kwargs):
...
class SNDCGANDiscriminator32(sndcgan_base.SNDCGANBaseDiscriminator):
    r"""
